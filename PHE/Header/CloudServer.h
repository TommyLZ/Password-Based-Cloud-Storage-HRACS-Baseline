...
public:
    ...
    void fileEncryption(element_t &mk, CryptoPP::byte *iv, string infilename, string outfilename, string ivpath);

    void fileDecryption (element_t& mk, CryptoPP::byte *iv, string infilename, string outfilename);
};
